...
export default function Register() {
    ...
    const handleSubmit = async (e) => {
        ...
        if (form.password != form.en_password) {
        ...
        formData.append('en_password', form.en_password);
    ...
    return (
        <>
            <section class="min-h-screen md:p-10">
                <div class="h-full">
                    <div
                        ...
                        <div class="mb-12 md:mb-0 md:w-8/12 lg:w-5/12 xl:w-5/12">
                            <form data-te-validation-init data-te-active-validation="true" onSubmit={handleSubmit}>
                                ...
                                >
                                    <input
                                        type="text"
                                        name="first_name"
                                        class="peer block min-h-[auto] w-full rounded border-0  px-3 py-[0.32rem] leading-[2.15] outline-none focus:placeholder:opacity-100 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-neutral-500 dark:placeholder:text-neutral-500 [&:not([data-te-input-placeholder-active])]:placeholder:opacity-1"
                                ...
                                <div class="relative mb-6"
                                    data-te-input-wrapper-init
                                    data-te-validate="input"
                                    data-te-validation-ruleset="isRequired|isLongerThan(11)"
                                >
                                    <input
                                        type="text"
                                        name="phone"
